...
return function (ContainerBuilder $containerBuilder) {
    $containerBuilder->addDefinitions([
        ...
        \App\Modules\Roles\Application\IRoleUseCase::class =>  \DI\autowire(\App\Modules\Roles\Application\UseCase\RoleUseCaseImpl::class),
        \App\Modules\Roles\Domain\IRoleRepository::class => \DI\autowire(\App\Modules\Roles\Infrastructure\Persistence\EloquentRoleRepository::class)
    ]);
};